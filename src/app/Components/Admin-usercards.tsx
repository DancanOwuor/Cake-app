  ...
  return (
    <div className='flex flex-col gap-4 w-screen mt-26 px-5'>
          ...
          <div className='md:flex flex flex-col gap-5'>
              {users.map((user:User, index:number) => ( <div key={index} className=' bg-blue-950 shadow-2xl text-white p-3 rounded-2xl flex flex-col gap-2 justify-center text-center'>
